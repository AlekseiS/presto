...
public final class DataResultsResponseHandler
{
    private static final JsonCodec<DataResults> DATA_RESULTS_JSON_CODEC = jsonCodec(DataResults.class);

    private DataResultsResponseHandler() {}

    public static DataResponse<DataResults> handle(Response response)
    {
        ...
        try {
            ...
            // TODO: figure out the right type check
...
//            }
            ...
            try {
                ...
                DataResults dataResults = DATA_RESULTS_JSON_CODEC.fromJson(responseBodyBytes);
                return new DataResponse<>(dataResults, responseBodyBytes.length, dataResults.getNextUri());
            }
            catch (IOException e) {
