...
public class TestLongColumnReader
{
    ...
    public void testReadBlock()
            throws Exception
    {
        List<PrestoThriftColumnData> columnsData = singleLongColumn(
    ...
    public void testReadBlockMultipleColumns()
            throws Exception
    {
        List<PrestoThriftColumnData> columnsData = ImmutableList.of(
    ...
    private static List<PrestoThriftColumnData> singleLongColumn(boolean[] nulls, long[] longs)
    {
        return ImmutableList.of(longColumn(nulls, longs, COLUMN_NAME));
    }

    private static PrestoThriftColumnData longColumn(boolean[] nulls, long[] longs, String columnName)
    {
        return new PrestoThriftColumnData(
                nulls,
                longs,
                null,
                null,
