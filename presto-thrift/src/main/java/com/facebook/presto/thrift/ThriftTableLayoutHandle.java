        ...
        implements ConnectorTableLayoutHandle
{
    ...
    {
        TupleDomain<ColumnHandle> predicate = thriftTupleDomainToTupleDomain(thriftLayout.getPredicate(), allColumns);
            ...
            Map<String, ColumnHandle> allColumns)
    {
        return new ConnectorTableLayoutResult(
                ...
                thriftTupleDomainToTupleDomain(result.getUnenforcedPredicate(), allColumns));
    }
}
