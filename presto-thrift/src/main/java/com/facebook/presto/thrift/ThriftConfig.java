...
public class ThriftConfig
{
    ...
    public ThriftConfig setMaxResponseSize(DataSize maxResponseSize)
    {
    ...
    public ThriftConfig setMaxIndexSplitsPerBatch(int maxIndexSplitsPerBatch)
    {
    ...
    public ThriftConfig setMetadataRefreshThreads(int metadataRefreshThreads)
    {
