...
import com.facebook.presto.thrift.clientproviders.PrestoThriftClientProvider;
import com.facebook.presto.thrift.clientproviders.RetryingPrestoClientProvider;
        ...
        implements Module
{
    ...
    public void configure(Binder binder)
    {
        ...
        binder.bind(PrestoClientProvider.class).annotatedWith(NonRetrying.class)
    ...
    @Singleton
    @ForMetadataRefresh
    public Executor createMetadataRefreshExecutor(ThriftConfig config)
    {
