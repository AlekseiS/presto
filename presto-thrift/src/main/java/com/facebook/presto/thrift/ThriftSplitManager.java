        ...
        implements ConnectorSplitManager
{
    ...
    @Inject
    public ThriftSplitManager(ThriftServiceClientProvider clientProvider, ThriftClientSessionProperties clientSessionProperties)
    {
            ...
            implements ConnectorSplitSource
    {
        ...
        private static ThriftConnectorSplit toConnectorSplit(ThriftSplit thriftSplit)
        {
