 ...
 */
package com.facebook.presto.thrift.location;
...
public class TestStaticLocationProvider
{
            ...
            throws Exception
    {
        ...
        HostLocationProvider provider = new StaticLocationProvider(new StaticLocationConfig().setHosts(HostsList.fromList(expected)));
