        ...
        implements PrestoThriftServiceProvider
{
    ...
    private PrestoThriftService connectTo(HostAddress host)
    {
        try {
            ...
            throw new PrestoException(ThriftErrorCode.CONNECTION_ERROR, "Execution error connecting to thrift host at " + host, e.getCause());
        }
        catch (TimeoutException e) {
            throw new PrestoException(ThriftErrorCode.CONNECTION_ERROR, "Cannot connect to thrift host at " + host, e);
        }
    }
}
