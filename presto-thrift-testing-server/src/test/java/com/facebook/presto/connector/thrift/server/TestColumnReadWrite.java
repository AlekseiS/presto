...
import com.facebook.presto.connector.thrift.api.datatypes.AbstractTestReadWrite;
import com.facebook.presto.spi.block.Block;
import com.facebook.presto.spi.type.Type;

import java.util.Random;

public class TestColumnReadWrite
        extends AbstractTestReadWrite
{
    ...
    {
        return ColumnWriters.toThriftBlock(block, type);
    }
}
