...
import static com.facebook.presto.thrift.interfaces.client.ThriftRangeValueSet.ThriftRange.Bound.toMarkerBound;
...
public final class ThriftSingleValue
{
    ...
    public static Marker toMarker(@Nullable ThriftSingleValue value, Type type, ThriftRangeValueSet.ThriftRange.Bound bound)
    {
        if (value == null) {
            ...
            return new Marker(type, Optional.of(block), toMarkerBound(bound));
        }
    }
}
